package com.study.wsh.fanshaoweather.activity;
...
import com.study.wsh.fanshaoweather.gson.Forecast;
...
import com.study.wsh.fanshaoweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private static final String KEY = "410368c3bc3741b994015721aab8c055";
    ...
    private void initData() {
        ...
        if(weatherString != null){
            Weather weather = WeatherHttpParse.handleWeatherResponse(weatherString);
        ...
        if(!TextUtils.isEmpty(bingPic)){
            Glide.with(this).load(bingPic).asBitmap().into(mBingPicImg);
        } else {
            loadBingPic();
        }
    ...
    public void requestWeather(String weatherId) {
        ...
        HttpUtil.sendOKHttpRequest(weatherUrl, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                final Weather weather = WeatherHttpParse.handleWeatherResponse(responseText);
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
