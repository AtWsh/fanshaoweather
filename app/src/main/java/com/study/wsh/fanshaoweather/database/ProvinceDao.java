...
public class ProvinceDao extends AbstractDao<Province, Long> {
    ...
    public static class Properties {
        ...
        public final static Property ProvinceId = new Property(2, int.class, "provinceId", false, "PROVINCE_ID");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PROVINCE\" (" + //
                ...
                "\"PROVINCE_NAME\" TEXT UNIQUE ," + // 1: provinceName
    ...
    public Province readEntity(Cursor cursor, int offset) {
        Province entity = new Province( //
            ...
            cursor.getInt(offset + 2) // provinceId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Province entity, int offset) {
        ...
        entity.setProvinceId(cursor.getInt(offset + 2));
     }
